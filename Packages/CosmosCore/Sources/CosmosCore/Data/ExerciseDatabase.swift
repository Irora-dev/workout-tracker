...
public struct ExerciseDatabase {
    ...
    public static let backExercises: [ExerciseData] = [
        ExerciseData(name: "Conventional Deadlift", primaryMuscle: .back, secondaryMuscles: [.hamstrings, .glutes, .abs], category: .compound, equipment: .barbell),
        ExerciseData(name: "Sumo Deadlift", primaryMuscle: .back, secondaryMuscles: [.hamstrings, .glutes, .quads], category: .compound, equipment: .barbell),
    ...
    public static let shoulderExercises: [ExerciseData] = [
        ...
        ExerciseData(name: "Push Press", primaryMuscle: .shoulders, secondaryMuscles: [.triceps, .quads], category: .compound, equipment: .barbell),
    ...
    public static let legExercises: [ExerciseData] = [
        // Quadriceps
        ExerciseData(name: "Barbell Back Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes, .hamstrings], category: .compound, equipment: .barbell),
        ExerciseData(name: "Barbell Front Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes, .abs], category: .compound, equipment: .barbell),
        ExerciseData(name: "Goblet Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .dumbbell),
        ExerciseData(name: "Leg Press", primaryMuscle: .quads, secondaryMuscles: [.glutes, .hamstrings], category: .compound, equipment: .machine),
        ExerciseData(name: "Hack Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .machine),
        ExerciseData(name: "V-Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .machine),
        ExerciseData(name: "Smith Machine Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes, .hamstrings], category: .compound, equipment: .machine),
        ExerciseData(name: "Leg Extension", primaryMuscle: .quads, secondaryMuscles: [], category: .isolation, equipment: .machine),
        ExerciseData(name: "Sissy Squat", primaryMuscle: .quads, secondaryMuscles: [], category: .isolation, equipment: .bodyweight),
        ExerciseData(name: "Walking Lunge", primaryMuscle: .quads, secondaryMuscles: [.glutes, .hamstrings], category: .compound, equipment: .dumbbell),
        ExerciseData(name: "Reverse Lunge", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .dumbbell),
        ExerciseData(name: "Bulgarian Split Squat", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .dumbbell),
        ExerciseData(name: "Step-Up", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .compound, equipment: .dumbbell),
        ExerciseData(name: "Cyclist Squat", primaryMuscle: .quads, secondaryMuscles: [], category: .compound, equipment: .dumbbell),
        ...
        ExerciseData(name: "Sumo Squat", primaryMuscle: .glutes, secondaryMuscles: [.quads], category: .compound, equipment: .dumbbell),
        ...
        // Adductors
        ExerciseData(name: "Hip Adduction Machine", primaryMuscle: .quads, secondaryMuscles: [], category: .isolation, equipment: .machine),
        ExerciseData(name: "Cable Hip Adduction", primaryMuscle: .quads, secondaryMuscles: [], category: .isolation, equipment: .cable),
    ]

    // MARK: - Core Exercises (20)
    public static let coreExercises: [ExerciseData] = [
        ExerciseData(name: "Plank", primaryMuscle: .abs, secondaryMuscles: [.abs], category: .calisthenics, equipment: .bodyweight, trackingType: .timeOnly),
        ExerciseData(name: "Side Plank", primaryMuscle: .obliques, secondaryMuscles: [.abs], category: .calisthenics, equipment: .bodyweight, trackingType: .timeOnly),
        ...
        ExerciseData(name: "Cable Woodchop", primaryMuscle: .obliques, secondaryMuscles: [.abs], category: .compound, equipment: .cable),
        ExerciseData(name: "Ab Wheel Rollout", primaryMuscle: .abs, secondaryMuscles: [.abs], category: .compound, equipment: .other, trackingType: .repsOnly),
        ExerciseData(name: "Dead Bug", primaryMuscle: .abs, secondaryMuscles: [.abs], category: .calisthenics, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Bird Dog", primaryMuscle: .abs, secondaryMuscles: [.back], category: .calisthenics, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Pallof Press", primaryMuscle: .abs, secondaryMuscles: [.obliques], category: .isolation, equipment: .cable, trackingType: .repsOnly),
        ...
        ExerciseData(name: "Dragon Flag", primaryMuscle: .abs, secondaryMuscles: [.abs], category: .calisthenics, equipment: .bench, trackingType: .repsOnly),
    ]

    // MARK: - Cardio Exercises (25)
    public static let cardioExercises: [ExerciseData] = [
        ExerciseData(name: "Treadmill Run", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .hamstrings], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Treadmill Walk", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Treadmill Incline Walk", primaryMuscle: .fullBody, secondaryMuscles: [.glutes, .calves], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Outdoor Run", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .hamstrings], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Outdoor Walk", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Hiking", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .glutes], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Stationary Bike", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Spin Class", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .machine, trackingType: .timeOnly),
        ExerciseData(name: "Outdoor Cycling", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Rowing Machine", primaryMuscle: .fullBody, secondaryMuscles: [.back, .biceps], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Elliptical", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .glutes], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Stair Climber", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .glutes], category: .cardio, equipment: .machine, trackingType: .timeOnly),
        ExerciseData(name: "Swimming Freestyle", primaryMuscle: .fullBody, secondaryMuscles: [.back, .shoulders], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Swimming Breaststroke", primaryMuscle: .fullBody, secondaryMuscles: [.chest, .shoulders], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Swimming Backstroke", primaryMuscle: .fullBody, secondaryMuscles: [.back, .shoulders], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Swimming Butterfly", primaryMuscle: .fullBody, secondaryMuscles: [.shoulders, .abs], category: .cardio, equipment: .none, trackingType: .distanceAndTime),
        ExerciseData(name: "Jump Rope", primaryMuscle: .fullBody, secondaryMuscles: [.calves], category: .cardio, equipment: .other, trackingType: .timeOnly),
        ExerciseData(name: "Battle Ropes", primaryMuscle: .fullBody, secondaryMuscles: [.shoulders, .abs], category: .cardio, equipment: .other, trackingType: .timeOnly),
        ExerciseData(name: "Assault Bike", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .shoulders], category: .cardio, equipment: .machine, trackingType: .caloriesOnly),
        ExerciseData(name: "Ski Erg", primaryMuscle: .fullBody, secondaryMuscles: [.back, .triceps], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "VersaClimber", primaryMuscle: .fullBody, secondaryMuscles: [.quads, .glutes], category: .cardio, equipment: .machine, trackingType: .distanceAndTime),
        ExerciseData(name: "Mountain Climber", primaryMuscle: .fullBody, secondaryMuscles: [.abs, .shoulders], category: .cardio, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Jumping Jacks", primaryMuscle: .fullBody, secondaryMuscles: [], category: .cardio, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "High Knees", primaryMuscle: .fullBody, secondaryMuscles: [.quads], category: .cardio, equipment: .bodyweight, trackingType: .timeOnly),
        ExerciseData(name: "Butt Kicks", primaryMuscle: .fullBody, secondaryMuscles: [.hamstrings], category: .cardio, equipment: .bodyweight, trackingType: .timeOnly),
    ]

    // MARK: - Plyometric Exercises (15)
    public static let plyometricExercises: [ExerciseData] = [
        ExerciseData(name: "Burpee", primaryMuscle: .fullBody, secondaryMuscles: [.fullBody], category: .plyometric, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Box Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes, .calves], category: .plyometric, equipment: .other, trackingType: .repsOnly),
        ExerciseData(name: "Broad Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .plyometric, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Tuck Jump", primaryMuscle: .quads, secondaryMuscles: [.abs], category: .plyometric, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Squat Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .plyometric, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Split Squat Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .plyometric, equipment: .bodyweight, trackingType: .repsOnly),
        ExerciseData(name: "Lateral Box Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .plyometric, equipment: .other, trackingType: .repsOnly),
        ExerciseData(name: "Depth Jump", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .plyometric, equipment: .other, trackingType: .repsOnly),
        ...
        ExerciseData(name: "Medicine Ball Slam", primaryMuscle: .fullBody, secondaryMuscles: [.abs], category: .plyometric, equipment: .medicineBall, trackingType: .repsOnly),
        ExerciseData(name: "Medicine Ball Throw", primaryMuscle: .fullBody, secondaryMuscles: [.abs], category: .plyometric, equipment: .medicineBall, trackingType: .repsOnly),
        ExerciseData(name: "Kettlebell Swing", primaryMuscle: .glutes, secondaryMuscles: [.hamstrings, .abs], category: .plyometric, equipment: .kettlebell),
        ExerciseData(name: "Kettlebell Snatch", primaryMuscle: .fullBody, secondaryMuscles: [.shoulders, .abs], category: .plyometric, equipment: .kettlebell),
        ExerciseData(name: "Kettlebell Clean", primaryMuscle: .fullBody, secondaryMuscles: [.biceps, .abs], category: .plyometric, equipment: .kettlebell),
        ExerciseData(name: "Power Clean", primaryMuscle: .fullBody, secondaryMuscles: [.back, .quads], category: .plyometric, equipment: .barbell),
    ]
    ...
    public static let flexibilityExercises: [ExerciseData] = [
        ...
        ExerciseData(name: "Cat-Cow Stretch", primaryMuscle: .back, secondaryMuscles: [.abs], category: .flexibility, equipment: .bodyweight, trackingType: .timeOnly),
        ...
        ExerciseData(name: "Standing Quad Stretch", primaryMuscle: .quads, secondaryMuscles: [], category: .flexibility, equipment: .bodyweight, trackingType: .timeOnly),
        ExerciseData(name: "Hip Flexor Stretch", primaryMuscle: .quads, secondaryMuscles: [.glutes], category: .flexibility, equipment: .bodyweight, trackingType: .timeOnly),
        ...
        ExerciseData(name: "Foam Roll IT Band", primaryMuscle: .quads, secondaryMuscles: [], category: .flexibility, equipment: .foamRoller, trackingType: .timeOnly),
        ExerciseData(name: "Foam Roll Quads", primaryMuscle: .quads, secondaryMuscles: [], category: .flexibility, equipment: .foamRoller, trackingType: .timeOnly),
        ...
        ExerciseData(name: "Thoracic Spine Rotation", primaryMuscle: .back, secondaryMuscles: [.abs], category: .flexibility, equipment: .bodyweight, trackingType: .repsOnly),
    ]
}
